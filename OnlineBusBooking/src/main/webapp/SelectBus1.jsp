...
<nav class="navbar">
   ...
   <h1 style='color:black'>AVAILABLE BUSES FROM  <% out.println(String.valueOf(session.getAttribute("source")).toUpperCase()); %> TO <% out.println(session.getAttribute("destination").toString().toUpperCase()); %></h1>
